...
<svelte:head>
  <title>Dashboard | EvidenceVault AI</title>
</svelte:head>
...
{:else}
  <div class="mb-8 flex items-center justify-between">
    <div>
      ...
      <h1 class="mt-1 text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Your cases</h1>
    </div>
  ...
  <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
    ...
    {:else}
      <div class="card col-span-full p-10 text-center">
        ...
        <h3 class="mt-4 text-lg font-semibold text-slate-900 dark:text-white">No cases yet</h3>
        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Create your first case to start tracking vulnerabilities and evidence.</p>
